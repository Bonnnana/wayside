        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenUntil = table.Column<string>(type: "TEXT", maxLength: 16, nullable: true),
                    Highlight = table.Column<string>(type: "TEXT", nullable: false),
                    AiSummary = table.Column<string>(type: "TEXT", nullable: false),
                    SummaryGeneratedUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    RefreshedUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TagsJson = table.Column<string>(type: "TEXT", nullable: false),
                    ReviewThemesJson = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
